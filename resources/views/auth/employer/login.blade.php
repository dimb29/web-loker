        ...
        <div class="lg:flex">
            <div class="lg:w-1/2 xl:max-w-screen-sm">
                <div class="py-12 bg-indigo-100 lg:bg-white flex justify-center lg:justify-start lg:px-12">
                    <div style="cursor: pointer;" onclick="window.location='https://sayarajin.com';" class="cursor-pointer flex items-center">
                        <div>
                        ...
                        <div class="text-2xl text-indigo-800 tracking-wide ml-2 font-semibold">Sayarajin</div>
                    </div>
                </div>
                    ...
                    <div class="mt-12">
                        ...
                        @csrf
                            <div>
                                ...
                                <x-jet-input id="email" type="email" name="email" :value="old('email')" required autofocus class="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" type="" placeholder="mike@gmail.com"/>
                            </div>
                            <div class="mt-8">
                        ...
                        <div class="mt-12 text-sm font-display font-semibold text-gray-700 text-center">
                            Don't have an account ? <a href="https://sayarajin.com/register" class="cursor-pointer text-indigo-600 hover:text-indigo-800">Sign up</a>
                        </div>
                    </div>
                </div>
            </div>
