...
<div class="max-w-7xl shadow-xl p-5 rounded-lg bg-blue-800">
    <div class="flex flex-col sm:flex-row">
        ...
        <div class="sm:w-48 ml-0 sm:ml-1 mr-0 sm:mr-1 mt-16 sm:mt-0 mb-1 sm:mb-0 grid justify-items-end">
        ...
        <div class="flex flex-row sm:flex-row">
            ...
            <div class="w-full sm:w-1/4 ml-0 sm:ml-0 mr-1 sm:mr-1 -mt-28 sm:mt-1 mb-1 sm:mb-0">
            ...
            <div class="w-full sm:w-1/4 ml-1 sm:ml-1 mr-0 sm:mr-0 -mt-28 sm:mt-1 mb-1 sm:mb-0">
