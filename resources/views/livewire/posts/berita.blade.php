...
<x-slot name="footer">
            ...
            <div class="sm:px-6 lg:px-8 ml-72 flex flex-row">
                        ...
                        <div class="flex-auto m-1">
                            <div class="flex flex-col">
                                    @foreach ($posts->skip(0)->take(5) as $post)
                                        <div data-id="{{ $post->id}}" class="daft-job bg-white rounded-lg shadow-xl my-6 transition duration-150 transform hover:scale-110 hover:-translate-y-2 
                ...
                <div class="hidden space-x-8 mt-10 mb-30 sm:flex w-4/5">
                <div class="relative">
                <div class="child hidden space-x-8 sm:flex w-4/5 myframe">
